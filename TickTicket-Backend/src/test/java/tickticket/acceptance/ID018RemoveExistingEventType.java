...
public class ID018RemoveExistingEventType {
    ...
    @Test
    public void testDeleteEventTypeSuccess(){
        try{
            assertTrue(eventTypeService.deleteEventType(EVENT_TYPE2_ID));
        }catch (Exception e){
            fail();
        }
    }
    ...
    @Test
    public void testDeleteEventTypeFail(){
        try{
