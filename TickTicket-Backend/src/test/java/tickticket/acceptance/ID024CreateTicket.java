...
public class ID024CreateTicket {
    ...
    public void createTicketSuccessful(){
        ...
        assertEquals(ticket.getEvent().getId(), EVENT1_ID);
        assertEquals(ticket.getEvent().getAddress(), EVENT1_ADDRESS);
        assertEquals(ticket.getEvent().getCapacity(), EVENT1_CAPACITY);
        assertEquals(ticket.getEvent().getCost(), EVENT1_COST);
        assertEquals(ticket.getEvent().getDescription(), EVENT1_DESCRIPTION);
        assertEquals(ticket.getEvent().getEmail(), EVENT1_EMAIL);
        assertEquals(ticket.getEvent().getPhoneNumber(), EVENT1_PHONE_NUMBER);
        assertEquals(ticket.getEvent().getEventTypes().get(0).getName(), EVENT_TYPE1_NAME);
    }

    @Test
    public void createTicketUserFailure(){
    ...
    @Test
    public void createTicketEventFailure(){
