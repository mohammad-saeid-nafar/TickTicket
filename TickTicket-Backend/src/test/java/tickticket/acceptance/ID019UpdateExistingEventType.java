...
public class ID019UpdateExistingEventType {
    ...
    @Test
    public void testUpdateEventTypeSuccess(){
        ...
        try{
            EventType eventType = eventTypeService.updateEventType(evTypeDTO);
            assertEquals(evTypeDTO.getName(), eventType.getName());
            assertEquals(evTypeDTO.getAgeRequirement(), eventType.getAgeRequirement());
            assertEquals(evTypeDTO.getDescription(), eventType.getDescription());
        }catch (Exception e){
            fail();
        }
    }
