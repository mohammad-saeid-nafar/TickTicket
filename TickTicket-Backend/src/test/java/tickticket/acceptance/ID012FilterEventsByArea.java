...
public class ID012FilterEventsByArea {
    ...
    public void setMockOutput() {
        ...
        lenient().when(eventRepository.findEventsByAddress(any(String.class))).thenAnswer((InvocationOnMock invocation) -> {
            if (invocation.getArgument((0)).equals(EVENT1_ADDRESS)) {
            ...
            else if (invocation.getArgument((0)).equals(EVENT2_ADDRESS)) {
    ...
    @Test
    public void filterEventsByArea1(){

        List<Event> events = new ArrayList<>();
        try{
            events = eventRepository.findEventsByAddress(EVENT1_ADDRESS);
    ...
    public void filterEventsByCapacity2(){
        ...
        List<Event> events = new ArrayList<>();
        try{
            events = eventRepository.findEventsByAddress(EVENT2_ADDRESS);
        }catch (IllegalArgumentException e){
            fail();
        }
