Feature: Show past events of user
  ...
  Background:
    ...
    Scenario Outline: Show a user his past events
      Given that the current date and time is "<dateTime>"
      When the user with "<userId>" attempts to see his past events
      ...
      Examples:
        ...
        | 2022-10-16 12:00 | 1      | 2         | [2,3]    |
        | 2022-10-10 12:00 | 1      | 1         | [2]      |

    Scenario: Show a user his past events fails
      Given that the current date and time is "2022-09-01 12:00"
      When the user with userId "1" attempts to see his past events
      Then the system shall raise the error "You do not have any past events."
