Feature: Filter Events By Area

  As a user
  I would like to filter events by area
  ...
  Background: 
    ...
    When the user attempts to view the events by area
  ...
  Scenario: Successfully view filtered events when 1 exists
    ...
    When the user attempts to view the filtered events by area and inputs "2620 rue Stanley"
