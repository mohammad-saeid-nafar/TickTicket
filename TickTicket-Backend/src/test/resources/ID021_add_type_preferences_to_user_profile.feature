Feature: Add Type Preferences To User Profile
  ...
  Background: 
    ...
    Given the following Event Type exists in the system:
      ...
      | 03 | Comedy      |    Comedy   | No age requirement |
    Given the following Profiles exist in the system:
      ...
      | 001 | name1      | famName     | address1 |  2001-02-19   | "profile_pic_1"  | name1@mail.com  | (514)111-0000   |           |
  ...
  Scenario Outline: Add 1 type preference to Profile successfully
    ...
    Examples: 
      | Id  | name  | lastName  | address  |  dateOfBirth  | profilePicture   | email           | phoneNumber     |  interests   |
      | 001 | name1 | famName   | address1 |  2001-02-19   | "profile_pic_1"  | name1@mail.com  | (514)111-0000   |  eventType1  |
  ...
  Scenario Outline: Add 3 type preference to Profile successfully
    ...
    Examples: 
      | Id  | name  | lastName  | address  |  dateOfBirth  | profilePicture   | email           | phoneNumber     | interests    |
      | 001 | name1 | famName   | address1 |  2001-02-19   | "profile_pic_1"  | name1@mail.com  | (514)111-0000   | eventType1, eventType2, eventType3 |
