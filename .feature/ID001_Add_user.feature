Feature: Create User
  ...
  Scenario Outline: Register a member account successfully
    ...
    Examples: 
      | id          | username  | password   | createdDate   |
      | 1           | aly1      | Aly12355   | 2022-10-01    |
      | 2           | aly2      | Aly12345   | 2022-10-03    |
      | 3           | aly3      | Aly123455  | 2022-10-05    |   
  ...
  Scenario Outline: Register member account failed
    ...
    Examples: 
      ...
      | 1           | aly1      | Aly12355   | 2022-10-01    | An account with this username already exists, please try another username
      | 2           | newUser   | aly12345   | 2022-10-03    | Please have at least one upper case letter, one lower case letter, and one number
