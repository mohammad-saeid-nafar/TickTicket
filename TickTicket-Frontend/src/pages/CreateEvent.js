...
const CreateEvent = () => {
    ...
    const handleCreateEvent = async(eventName, eventDescription, eventCapacity, eventCost, eventStart, eventEnd, eventAddress, eventPhoneNumber, eventEmail, chosenEventTypes) => {
        ...
        <>
            ...
            <TabPanel value={tab} index={1}>
                ...
                <Stack sx={{ width: '100%' }} spacing={2}>
                    ...
                    {success && <Alert severity="success">A new Event has been successfully created!</Alert>}
                </Stack>
            </TabPanel>
            </Container>
        </>
